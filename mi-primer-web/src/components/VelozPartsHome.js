// src/components/VelozPartsHome.js
import React, { useState, useEffect } from 'react';
import { useNavigate } from 'react-router-dom'; // <-- Aquí se importa useNavigate
import LogoutButton from './LogoutButton';
import logo from '../logo.svg'; // <-- Importa logo.svg para el fondo
...
function VelozPartsHome() {
  ...
  return (
    <div className="App" style={{ position: 'relative' }}> {/* Agrega position relative para el fondo */}
      {/* Imagen de fondo (logo.svg) */}
      <img
        src={logo}
        alt="Fondo"
        style={{
          ...
          objectFit: 'cover',
          zIndex: -1,
          opacity: 0.1, // Baja opacidad para que no tape el contenido
        }}
      />
      ...
      <header className="header">
        <nav className="nav">
          ...
          <ul className="nav-links">
            ...
            <li><LogoutButton /></li> {/* <-- Botón de cerrar sesión integrado aquí, al lado de Contacto */}
          </ul>
        </nav>
      </header>
